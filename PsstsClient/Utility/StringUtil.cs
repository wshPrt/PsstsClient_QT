...
namespace PsstsClient.Utility
{
    public class StringUtil
    {
        ...
        /// byte数组转十六进制字符串
        /// </summary>
        /// <param name="recData">需要转换的byte数组</param>
        /// <returns></returns>
        ...
        * ******************************************************************/
        ...
        /// 字符串补齐
        /// </summary>
        /// <param name="comLength">补齐长度</param>
        /// <param name="comStr">补齐的字符串</param>
        /// <param name="source">源字符串</param>
        /// <returns></returns>
        public static string StrCompletion(int comLength, string comStr, string source)
        {
            if (comLength == source.Length)
            {
                return source;
            }
            ...
            for (int i = 0; i < comLength - souLen; i++)
            {
                result += comStr;
            }
